 ...
 * 
 * This version is for Lab 12. It includes a size for the House
 * objects.
 * 
...
public class CityPanel extends JPanel implements MouseListener, MouseMotionListener{
	...
	public void paintComponent(Graphics g) {
		...
		// Draw the preview (of the next house to be drawn).
		this.preview.draw(g);
	}
	 ...
	 * @param isX - true if horizontal size is to be updated, false if vertical size is to be updated
	 */
	...
	public void mouseClicked(MouseEvent e) {
		this.houses.add(new House(e.getX(), e.getY(), this.sizeX, this.sizeY, this.color));
		this.repaint();
	}
	 ...
	 * 
	 * @param e - object with info on the mouse motion event
	 */
